			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					...
					<div id="stores" align="center">
						<img src="<?=$this->config->item('assets');?>images/apple.png" width="200" height="60" alt="Baixe o Beeziness para iOS" title="Baixe o Beeziness para iOS" />
						<a href ="https://play.google.com/store/apps/details?id=app.com.beeziness&hl=pt_BR">
							<img src="<?=$this->config->item('assets');?>images/play.png" width="200" height="64" alt="Baixe o Beeziness para Android" title="Baixe o Beeziness para Android"/>
						</a>
					</div>	
				</div>
			</div>
